...
public class InvoiceUtils {
    ...
    public static Map<String, Object> invoiceBaseVatMap = new LinkedHashMap<>();

    /** 增值税通用发票数据（增值税普票，增值税专票，电子普通发票） */
    public static Map<String, Object> invoiceVatMap = new LinkedHashMap<>();

    /** 机动车统一发票数据 */
    public static Map<String, Object> vehicleVatMap = new LinkedHashMap<>();

    /** 增值税卷式普通发票 */
    public static Map<String, Object> rollVatMap = new LinkedHashMap<>();

    /** 电子普通[通行费]发票 */
    public static Map<String, Object> tollVatMap = new LinkedHashMap<>();

    /** 二手车销售统一发票 */
    public static Map<String, Object> usedCarVatMap = new LinkedHashMap<>();
    static {
